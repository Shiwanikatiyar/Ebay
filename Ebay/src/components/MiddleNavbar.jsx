...
import {
    Flex, Box, Link, Image, Menu, MenuButton, MenuList, MenuItem, Input, Button
    ...
    return (
        <Box w={{ base: "100%", md: "95%" }} px={{ base: 2, md: 10 }} pt={1}>
            <Flex px={10} py={1} alignItems="center" justifyContent="space-between">
                ...
                {/* Search button */}
                <Button backgroundColor='#3665F3' color="white" _hover={{ bg: '#3665F3' }} size="lg" m={3} px={{ base: 3, md: 10 }}>
                    Search
                </Button>
